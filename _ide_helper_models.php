 ...
 * @property int $status
 * @property mixed $restriction_entries
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 ...
 * @property int|null $barangay_code
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|MemberInformation whereProfilePhotoUrl($value)
 ...
 * @property-read \App\Models\Cluster|null $cluster_lead
 * @property-read \Spatie\MediaLibrary\MediaCollections\Models\Collections\MediaCollection|\Spatie\MediaLibrary\MediaCollections\Models\Media[] $media
 * @property-read int|null $media_count
