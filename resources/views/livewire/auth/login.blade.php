<div>
    <div class="flex justify-center mt-20">
        <div class="p-5 rounded-lg bg-white flex flex-col w-[30rem] shadow-sm">
            ...
            <form wire:submit.prevent="authenticate" class="mt-7">
                <section>
                    ...
                    <div class="flex items-center px-2 py-1 mt-2 bg-white border rounded-md">
                        ...
                        <input required wire:model.defer="username" type="text" placeholder="Enter your username" class="flex-1 p-2 border-none focus:outline-none focus:ring-0">
                    </div>
                </section>
                <section class="mt-2">
                    ...
                    <div class="flex items-center px-2 py-1 mt-2 bg-white border rounded-md">
                        ...
                        <input required wire:model.defer="password" type="password" placeholder="Password" class="flex-1 p-2 border-none focus:outline-none focus:ring-0">
                    </div>
                </section>
                <x-filament-support::button type="submit" class="w-full py-3 mt-5 text-white rounded-md bg-primary-500" wire:target="authenticate">Login</x-filament-support::button>
            </form>
        </div>
    </div>
