            ...
            <form class="mt-7" wire:submit.prevent="authenticate">
                <section>
                    ...
                    <div class="flex items-center px-2 py-1 mt-2 bg-white border rounded-md">
                        ...
                        <input class="flex-1 p-2 border-none focus:outline-none focus:ring-0" type="text" required
                            wire:model.defer="username" placeholder="Enter your username">
                    </div>
                </section>
                <section class="mt-2">
                    ...
                    <div class="flex items-center px-2 py-1 mt-2 bg-white border rounded-md">
                        ...
                        <input class="flex-1 p-2 border-none focus:outline-none focus:ring-0" type="password" required
                            wire:model.defer="password" placeholder="Password">
                    </div>
                </section>
                <x-filament-support::button class="w-full py-3 mt-5 text-white rounded-md bg-primary-500" type="submit"
                    wire:target="authenticate">Login</x-filament-support::button>
            </form>
        </div>
    </div>
