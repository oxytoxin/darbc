<div class="relative">
    <div class="absolute inset-0 z-30 bg-white" wire:loading.delay wire:target="tableFilters">
    ...
    <table class="min-w-full border divide-y divide-gray-500">
        <thead class="bg-primary-500">
            <tr>
                <th class="py-2.5 min-w-[6rem] text-white px-3 text-left font-semibold col-span-3" scope="col">
                    DARBC ID
                </th>
                <th class="py-2.5 min-w-[12rem] text-white px-3 text-left font-semibold col-span-3" scope="col">
                    Last Name
                ...
                @foreach ($releases as $release)
                    <th class="w-[8rem] py-2.5 text-white px-3 font-semibold @if ($release->disbursed) bg-custom-green
                    @else
                    bg-yellow-500 @endif border-r" scope="col">
                        <div class='flex items-center space-x-3'>
                            <div class="flex flex-col flex-1 leading-4" title="{{ $release->name }}">
                ...
                @endforeach
                <th class="py-2.5 text-white px-3 font-semibold border text-center leading-4" scope="col">&nbsp;</th>
                <th class="w-[7rem] py-2.5 text-white px-3 font-semibold border text-center leading-4" scope="col">Status
                </th>
                <th class="w-[10rem] py-2.5 text-white px-3 font-semibold border-r text-center leading-4" scope="col">Amount</th>
            </tr>
        </thead>
