                    ...
                    <div class="flex-1 p-6">
                        ...
                        <div class="mt-2">
                            @if (round($release->total_amount) == round($dividends_net_amount))
                                <x-filament::modal>
                                    <x-slot name="trigger">
                                        <x-forms::button class="!px-44 whitespace-nowrap bg-custom-green hover:!bg-green-hover focus:!bg-green-hover focus:!ring-0 focus:!ring-offset-0" @click="isOpen = true">
                    ...
                    <div class='flex items-center w-full space-x-3'>
                        <form action="#" x-data="{ files: null }">
                            <label class="border p-2.5 w-full block rounded-md cursor-pointer my-2 bg-custom-green text-white" for="excelfile">
                                ...
                                <input class="sr-only" id="excelfile" type="file" x-on:change="files = Object.values($event.target.files)">
                            </label>
                        </form>
                    </div>
                </div>
