    ...
    <div class="border-2 border-black">
            ...
            <div class="grid grid-cols-4">
                ...
                <div class="col-span-3  border-r-2 border-black p-4 ">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-extrabold uppercase leading-none">ANI AT KITA <br> RSBSA Enrollment Form</h1>
                            <p class="text-sm font-semibold uppercase text-gray-700 mt-1">Registry System for Basic Sectors in Agriculture (RSBSA)</p>
                        </div>
                    </div>

                    <!-- Enrollment Type & Date -->
                    <div class="flex items-center mt-4">
                        <p class="text-xs font-bold uppercase min-w-[160px]">Enrollment Type & <br> Date Administered:</p>
                        <div class="flex items-center space-x-4">
                        ...
                        <div class="flex space-x-2">
                            ...
                            <div class="flex flex-col">
                                <div class="flex border border-black">
                                    <div class="w-6 h-6 flex items-center justify-center text-xs border-r border-black">1</div>
                            ...
                            <div class="flex flex-col">
                                <div class="flex border border-black">
                                    <div class="w-6 h-6 flex items-center justify-center text-xs border-r border-black">3</div>
                            ...
                            <div class="flex flex-col">
                                <div class="flex border border-black">
                                    <div class="w-6 h-6 flex items-center justify-center text-xs border-r border-black">2</div>
                                    <div class="w-6 h-6 flex items-center justify-center text-xs border-r border-black">3</div>
                                    <div class="w-6 h-6 flex items-center justify-center text-xs border-r border-black">4</div>
                                    <div class="w-6 h-6 flex items-center justify-center text-xs border-r border-black">2</div>
                                    <div class="w-6 h-6 flex items-center justify-center text-xs">1</div>
                                </div>
        ...
        <div class="border-2 border-black mt-4">
            ...
            <div class="border-t-2 border-black p-2 flex justify-between text-xs font-bold">
                ...
                <span>Farming: ₱25,000</span>
                <span>Non-farming: ₱10,000</span>
            </div>
        </div>
        ...
        <div class="relative  border-black mt-4">
            <div
                class="absolute left-0 right-0 top-1/2 transform -translate-y-1/2 border-t border-dashed border-black w-full ">
            </div>
            <i
                class="fas fa-cut absolute right-0 top-1/2 transform -translate-y-1/2 rotate-180 text-gray-600 text-xl bg-white"></i>
        </div>

        <div class="border-2 border-black mt-8 p-4 ">
            <!-- Header -->
            <div class="text-center">
                <h1 class="text-xl font-bold uppercase">Registry System for Basic Sectors in Agriculture (RSBSA)</h1>
                <p class="text-lg font-bold uppercase">Enrollment Client’s Copy</p>
            </div>
            ...
            <div class="mt-4">
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <div class="flex flex-col">
                        <div class="flex border border-black">
                            <div
                                class="w-6 h-6 flex items-center justify-center text-gray-800 font-semibold border-r border-black">
                                1</div>
            ...
            <!-- Footer -->
            <div class="text-center font-bold uppercase text-sm mt-2">
