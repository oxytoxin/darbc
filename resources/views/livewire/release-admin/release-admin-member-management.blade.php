        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center justify-end">
                <section class="flex items-center space-x-2">
                    <x-minor.button class="bg-custom-green/[8%] text-custom-green" href="{{ route('release-admin.download-report.members') }}" target="_blank" buttonContent="Export to Excel">
                    ...
                    <x-minor.button class="text-white bg-custom-blue" href="{{ route('release-admin.register-members') }}" buttonContent="Add member">
