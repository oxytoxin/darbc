        ...
        <div class="flex flex-col items-center justify-center">
            <section class="bg-white rounded-md w-[40rem] p-5 my-[2rem] h-full space-y-3">
                <div class="flex items-center justify-between">
                    <h1 class="text-custom-blue font-semibold uppercase">Upload signature</h1>
                    <button>
                ...
                <div class="h-full w-full">
                    <main class="container mx-auto max-w-screen-lg h-full">
                        <!-- file upload modal -->
                        <article aria-label="File Upload Modal" class="relative h-full flex flex-col bg-white rounded-md"
                            ...
                            <section class="h-full overflow-auto p-8 w-full flex flex-col">
                                <header class="border-dashed border-2 border-gray-400 py-12 flex flex-col justify-center items-center">
                                    <p class="mb-3 font-semibold text-gray-900 flex flex-wrap justify-center">
                                        <span>Drag and drop signature</span>&nbsp;<span>file anywhere or</span>
                                    </p>
                            ...
                            <footer class="flex justify-end px-8 pb-8 pt-4">
                                ...
                                <x-minor.button buttonContent="Upload signature" id="submit" class="bg-custom-blue text-white" />
                            </footer>
                        </article>
                    </main>
                </div>
