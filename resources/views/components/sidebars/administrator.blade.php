<div class="relative h-full">
    <div class="w-[18rem] fixed top-0 left-0 bottom-0 bg-white overflow-hidden px-[1rem] py-[1.2rem]">
        ...
        <div class="mt-[2.5rem] z-[9999]">
            <x-minor.nav-link href="{{ route('administrator.dashboard') }}" :active="request()->routeIs('administrator.dashboard')">
            ...
            <x-minor.nav-link href="{{ route('administrator.manage-members') }}" :active="request()->routeIs('administrator.manage-members')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <x-minor.nav-link href="{{ route('administrator.manage-clusters') }}" :active="request()->routeIs('administrator.manage-clusters')">
            ...
            <x-minor.nav-link href="{{ route('administrator.manage-users') }}" :active="request()->routeIs('administrator.manage-users')">
            ...
            <x-minor.nav-link href="{{ route('administrator.manage-releases') }}" :active="request()->routeIs('administrator.manage-releases')">
            ...
            <x-minor.nav-link href="#" :active="false">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" stroke-width=".1" stroke="currentColor" class="w-5 h-5">
                    <path class="fill-current" d="M8 20v-6h8v6h3V4H5v16h3zm2 0h4v-4h-4v4zm11 0h2v2H1v-2h2V3a1 1 0 0 1 1-1h16a1 1 0 0 1 1 1v17zM11 8V6h2v2h2v2h-2v2h-2v-2H9V8h2z" />
                </svg>
